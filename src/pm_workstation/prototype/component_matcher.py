...
class ComponentMatcher:
    ...
    async def match_for_page(
        ...
        suggested_components: list[str] | None = None,
    ...
    def _infer_category_from_operation(self, operation: str) -> ComponentCategory | None:
        """从操作推断组件分类"""
    ...
    async def _search_by_name(self, name: str) -> ComponentSearchResult | None:
        """按名称搜索组件"""
