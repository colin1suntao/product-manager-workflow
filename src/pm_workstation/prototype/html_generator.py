...
class HTMLGenerator:
    ...
    def __init__(
        self,
        component_matcher: ComponentMatcher | None = None,
        interaction_configurator: InteractionConfigurator | None = None,
    ):
...
<head>
    ...
    def _generate_table_content(self, page: PageNode) -> str:
        ...
        toolbar = """<div style="display: flex; justify-content: space-between; margin-bottom: 16px;">
